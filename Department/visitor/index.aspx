<%@ Page Title="" Language="C#" MasterPageFile="~/Department/visitor/visitor.master" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="Department_visitor_index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="pages  toolbar-through">
          ...
          <div data-page="index" class="page homepage">
			...
			<div class="logo"><%--<img src="../../assets/RangeelaRass-Logox550.png" alt="" title="" />--%></div> 
            </div>
          </div>
