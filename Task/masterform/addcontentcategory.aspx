<%@ Page Title="" Language="C#" MasterPageFile="~/Department/admin/admin.master" AutoEventWireup="true" CodeFile="addcontentcategory.aspx.cs" Inherits="Task_masterform_addcontentcategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="block">
        <div class="block-header block-header-default bg-primary">
                <h3 class="block-title text-white"><i class="fa fa-plus"></i> Add Content Category</h3>
            </div>
        <!-- Form -->
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <div class="form-material ">
                                ...
                                <label for="<%=txtname.ClientID %>">Content Name</label>
                            </div>
                        </div>
                    </div>
                       ...
                       <div class="col-md-3">
                        <div class="form-group row">
                            <label class="col-12" for="example-select">Content Type</label>    
                            <div class="col-md-12">
                                <asp:dropdownlist id="drdtype" runat="server" class="js-select2 form-control" >
       ...
       <div class="block">
        <div class="block-header block-header-default bg-primary">
            <h3 class="block-title text-white"><i class="fa fa-list"></i> View Content Type</h3>
