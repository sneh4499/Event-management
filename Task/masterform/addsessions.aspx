<%@ Page Title="" Language="C#" MasterPageFile="~/Department/admin/admin.master" AutoEventWireup="true" CodeFile="addsessions.aspx.cs" Inherits="Task_masterform_addsessions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <div class="block">
        <div class="block-header block-header-default bg-primary">
                <h3 class="block-title text-white"><i class="fa fa-plus"></i> Add Session</h3>
            </div>
        <!-- Form -->
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <div class="form-material ">
                                ...
                                <label for="<%=txtname.ClientID %>">Session Name</label>
                            </div>
                        </div>
                    </div>
       ...
       <div class="block">
        <div class="block-header block-header-default bg-primary">
            <h3 class="block-title text-white"><i class="fa fa-list"></i> View Session</h3>
